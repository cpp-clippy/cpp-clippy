...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_AUTOSAR_M712CHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_AUTOSAR_M712CHECK_H
...
class M712Check : public ClangTidyCheck {
public:
  M712Check(StringRef Name, ClangTidyContext *Context)
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_AUTOSAR_M712CHECK_H

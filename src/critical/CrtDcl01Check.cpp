...
void CrtDcl01Check::storeOptions(
...
void CrtDcl01Check::registerMatchers(MatchFinder *Finder) {
...
template <typename LiteralType>
bool CrtDcl01Check::checkBoundMatch(
